...
int main() {
  ...
  // CalculiX: controls initialization
  //----------------------------------------------------------------------------------
  ...
  while (!WindowShouldClose()) // Detect window close button or ESC key
  {
    ...
    //----------------------------------------------------------------------------------
    if (GuiTextBox((Rectangle){0, 0, 360, 64}, boxText, 128, TextBox000EditMode)) TextBox000EditMode = !TextBox000EditMode;
    if (GuiButton((Rectangle){0, 72,90, 72}, "1")) Button001();
    if (GuiButton((Rectangle){90, 72,90, 72}, "2")) Button002();
    if (GuiButton((Rectangle){180, 72,90, 72}, "3")) Button003();
    if (GuiButton((Rectangle){270, 72,90, 72}, ".")) Button004();
    if (GuiButton((Rectangle){0,144,90, 72}, "4")) Button005();
    if (GuiButton((Rectangle){90,144,90, 72}, "5")) Button006();
    if (GuiButton((Rectangle){180,144,90, 72}, "6")) Button007();
    if (GuiButton((Rectangle){270,144,90, 72}, "+")) Button008();
    if (GuiButton((Rectangle){0,216,90, 72}, "7")) Button009();
    if (GuiButton((Rectangle){90,216,90, 72}, "8")) Button010();
    if (GuiButton((Rectangle){180,216,90, 72}, "9")) Button011();
    if (GuiButton((Rectangle){270,216,90, 72}, "-")) Button012();
    if (GuiButton((Rectangle){0,288,90, 72}, "0")) Button013();
    if (GuiButton((Rectangle){90,288,90, 72}, "(")) Button014();
    if (GuiButton((Rectangle){180,288,90, 72}, ")")) Button015();
    if (GuiButton((Rectangle){270,288,90, 72}, "x")) Button016();
    if (GuiButton((Rectangle){0,360,90, 72}, "Root")) Button017();
    if (GuiButton((Rectangle){90,360,90, 72}, "Pow")) Button018();
    if (GuiButton((Rectangle){180,360,90, 72}, "F->C")) Button019();
